...
*   Установите PostgreSQL. Для установки достаточна та версия, что есть в системном репозитории Debian 11.
...
# 3. Установка Zabbix Server, Web-frontend, Apache и PHP
...
# В файле /etc/zabbix/zabbix_server.conf раскомментировать и задать пароль:
# DBPassword=ваш_пароль

# В файле /etc/php/*/apache2/php.ini раскомментировать и задать таймзону:
...
*    Добавьте Zabbix Server в список разрешенных серверов ваших Zabbix Agents.
*    Добавьте Zabbix Agents в раздел Configuration > Hosts вашего Zabbix Server.
...
Используемые команды (для удаленного хоста wow-agent-home)
